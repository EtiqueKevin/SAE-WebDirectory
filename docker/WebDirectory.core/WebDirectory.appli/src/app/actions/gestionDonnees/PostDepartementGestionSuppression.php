...
class PostDepartementGestionSuppression extends AbstractAction{
    ...
    public function __invoke(Request $request, Response $response, array $args): Response{
            ...
            try {
                $this->departementService->deleteDepartement($data['id']);
            } catch (OrmException $e) {
                throw new HttpBadRequestException($request, $e->getMessage());
            }

            return $response->withHeader('Location', '/departements')->withStatus(302);
    }
