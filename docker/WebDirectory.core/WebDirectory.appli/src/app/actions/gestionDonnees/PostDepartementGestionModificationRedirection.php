...
class PostDepartementGestionModificationRedirection extends AbstractAction{
    ...
    public function __invoke(Request $request, Response $response, array $args): Response{
            ...
            return $response->withHeader('Location', '/departement/modification?id='.$data['id'])->withStatus(302);
    }
